...
Description = "Powershell module with commands to easily add or remove items from `'collection type`' Windows Environment Variables. For example, add `'C:\foo`' to `$env:Path."
